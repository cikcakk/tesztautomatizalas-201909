...
* Írj egy függvényt `multiplyWithForm` néven, ami vár két számot,
...
* Írj egy függvényt `multiplyWithTable` néven, ami vár két számot,
...
* Írj egy függvényt, mely visszaolvassa a monogramot! (Vedd észre, ahogy
...
* Írj egy függvényt, mely paraméterek alapján beírj a második képernyőn
